...
function ConfirmRoom(data) {
  ...
  const confirmSubmit = async (e) => {
    ...
    if (studentId !== "Guest") {
      ...
      alert(
        `Success! ${studentId} your allotted room is ${data.block}/${data.floor}/${data.room}. Since you are a Guest, the allocated room will not be registered in the database.`
      );
      navigate("/thanks-page");
      setButtonText("Submit");
      setIsButtonDisabled(false);
